...
function Footer() {
	return (
		<div className="bg-[#172337]">
			<div className="border-b-[1px] border-[#454d5e]">
				<div className="max-w-[90%] m-auto flex flex-row gap-6 justify-between ">
					<div className="py-8 flex flex-row justify-between w-[50vw]">
						...
						<div className="border-r-[1px] border-[#454d5e]"></div>
					</div>
						...
						<div className="">
							...
							<p>
								<h4 className="text-[#fff] text-[14px] p-[1px] ">
									...
									<br /> &Clove Embassy Tech Village,Outer Ring Road,
						...
						<div className="">
							...
							<p>
								<h4 className="text-[#fff] text-[14px] p-[1px] ">
									...
									<br /> Bengaluru, 560103,
									<br /> Karnataka, India
									<br /> CIN : U51109KA2012PTC066107
									<br />
									Telephone:
									<span className="text-blue-600"> 044-45614700</span>
								</h4>
							</p>
						</div>
					</div>
			...
			<div className="max-w-[80%] m-auto py-[25px]">
				<div className="flex flex-row justify-between text-white text-[16px]">
